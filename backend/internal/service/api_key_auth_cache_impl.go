...
// v25 combines local authorization fields with upstream model allowlist enforcement.
// Both branches used v24 for different schemas; refresh either old snapshot.
