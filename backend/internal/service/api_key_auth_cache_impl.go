...
// v20 combines local per-key platform permissions with upstream search/audio/
// video-model pricing fields. Both branches used v19 for different snapshot
// shapes, so merged deployments must refresh all pre-merge entries.
